...
export default function InputHours() {
   ...
   const filteredTimes = hours.filter((time) => {
    ...
    return hour > +start.split(':')[0] || (hour === +start.split(':')[0] && minute > +start.split(':')[1]);
    });
   ...
   return (
      <div className={styles.fader}>
         ...
         <div className={styles.container}>
            ...
            <select  onChange={(e) => ChangeNumber(e)} name="hours1" className={styles.abc} >
         ...
         <div className='w210'>
            ...
            <select   onChange={(e) => HoursLimit(e)} name="hours1" className={styles.abc}>
